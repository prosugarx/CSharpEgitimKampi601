...
namespace CSharpEgitimKampi601
{
    public partial class FrmCustomer : Form
    {
        ...
        string connectionString = "Server = localhost; port=5432; Database=Customer; user Id=postgres; Password=Prokilit";
        ...
        private void btnCustomerUpdate_Click(object sender, EventArgs e)
        {
            ...
            var connection = new NpgsqlConnection( connectionString);
            connection.Open();
            string query = "Update customer Set CustomerSurname=@customerSurname,CustomerName=@customerName,CustomerCity=@customerCity where CustomerId=@customerId";
            var command=new NpgsqlCommand(query, connection);
            command.Parameters.AddWithValue("@customerSurname",customerSurname);
            command.Parameters.AddWithValue("@customerName",customerName);
            command.Parameters.AddWithValue("@customerCity",customerCity);
